...
FROM ghcr.io/adalinxx/lattice-node:sha-4ae74d4 AS node
...
ADD https://raw.githubusercontent.com/adalinxx/lattice-node/4ae74d4c/deploy/mine-supervisor.py /usr/local/bin/mine-supervisor.py
